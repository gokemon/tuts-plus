...
![git status lifecyle](https://-----------local-and-remote-git/master/images/git-status-lifecycle.png)
...
![git status lifecyle](https://raw.github-------local-and-remote-git/master/images/Git-Cheat-Sheet.png)
